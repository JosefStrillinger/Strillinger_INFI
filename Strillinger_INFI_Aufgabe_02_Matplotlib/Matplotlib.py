...
mean_temp_2009_fil = mean_temp_2009[~np.isnan(mean_temp_2009)]# ==> es befinden sich nan werte in der ursprungsdatei, die dann später zu fehlern beim boxplot führen würden, so werden sie entfernt

mean_temp_2020_fil = mean_temp_2020[~np.isnan(mean_temp_2020)]

# plt.boxplot([mean_temp_1979, mean_temp_1989, mean_temp_1999, mean_temp_2009, mean_temp_2020] )
